...
const Star: React.FC<StarProps> = ({ avaliar, preencher, notaTemp, resetar }) => {
    return (
        
        <div onClick={avaliar} onMouseEnter={notaTemp} onMouseLeave={resetar} className="cursor-pointer">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill={preencher ? "orange" : "white"}
                width="32"
                height="32"
                viewBox="0 0 24 24"
                stroke="orange"
